  ...
  <footer class="footer py-4 px-4">
    ...
    >
      <div class="mb-3 mb-md-0 text-white-50">
        © {{ new Date().getFullYear() }} Daniel Esteban. Todos los derechos
        reservados.
      </div>
...
<style scoped>
.footer {
  background-color: #000000; /* Igual que el fondo del sitio */
  border-top: 2px solid rgba(255, 77, 109, 0.1); /* Línea superior sutil */
  color: #f0f0f0;
}
